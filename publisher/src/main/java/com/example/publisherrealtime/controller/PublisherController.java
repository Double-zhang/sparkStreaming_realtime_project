package com.example.publisherrealtime.controller;
...
public class PublisherController {
    ...
    public List<NameValue> statsByItem(
        ...
        List<NameValue> result = publisherService.daStatsByItem(itemName,date,t);
        return result;
    }
     ...
     * &itemName=小米手机&pageNo=1&pageSize=20                      请求参数
     */
