...
import com.hitsz.gmall.realtime.bean.{PageActionLog, PageDisplayLog, PageLog, StartLog}
import com.hitsz.gmall.realtime.util.{MyKafkaUtils, MyOffsetsUtils}
  ...
  def main(args: Array[String]): Unit = {
    ...
    jsonObjDStream.foreachRDD(
      rdd => {
        ...
        //foreachRDD里面，forech外面   Driver段执行，一批次执行一次（周期性）
